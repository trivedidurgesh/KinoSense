...
public class RuleAdapter {
    ...
    public long insertRule(final String rule, final int actionID, final int triggerID, final String additionalInfo) {
    ...
    public Cursor getAllRules() {
        return this.db.query(RuleDataBase.getDatabaseTable(), new String[] { RuleDataBase.KEY_ROWID, RuleDataBase.KEY_RULE, RuleDataBase.ACTION_ID,
                RuleDataBase.TRIGGER_ID, RuleDataBase.ADDITION_INFO }, null, null, null, null, null);
    }
