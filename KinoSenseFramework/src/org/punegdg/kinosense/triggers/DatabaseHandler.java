...
/**
 * DatabaseHandler class to store data in SQLite database. Data objects that are persistent in KinoSense Application are
...
public class DatabaseHandler extends SQLiteOpenHelper
{
	...
	{
		String CREATE_SIM_TABLE = "CREATE TABLE " + TABLE_SIM_INFO + "(" + KEY_ID + " INTEGER PRIMARY KEY," + KEY_SERIAL
				+ " TEXT" + ")";
	 ...
	 * @param serialNumber
	 */
	public void addSimSerial(String serialNumber)
	{
